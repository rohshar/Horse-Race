...
def optimalHorseRacing3(in_file):
        ...
        best_teams_val = -1
        for i in range(num_runs):
                curr_teams_val, curr_teams = LongestPathSolution(horse_performance, horse_compatibilities, 0.5)
                if curr_teams_val > best_teams_val:
                        best_teams_val = curr_teams_val
                        best_teams = curr_teams
...
if __name__ == "__main__":
        counter = 1
        with open("answers_small_longest_path_testing.out", "r+") as ofile, open("perf_small_longest_path_testing.out", "r+") as pfile:
                ofile.truncate()
                pfile.truncate()
                ...
                for f in files:
                        ...
                        print(counter)
                        print f
                        # perf, teams = optimalHorseRacing3("cs170_final_inputs/" + f)
