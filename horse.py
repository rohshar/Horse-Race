...
def optimalHorseRacing(in_file):
        ...
        for i in range(num_runs):
                curr_teams = randomizedSolution(horse_performance, horse_compatibilities, 0.1)
...
if __name__ == "__main__":
        counter = 1
        #with open("answers_small_greedy_random.out", "r+") as ofile, open("perf_small_greedy_random.out", "r+") as pfile:
        ...
        #with open("answers_full_greedy.out", "r+") as ofile, open("perf_full_greedy.out", "r+") as pfile:
                ...
                for f in files:
                        ...
                        perf, teams = optimalHorseRacing("sample_checker/" + f)
        ...
        f = 'sample_checker/1.in'
        val, teams = optimalHorseRacing(f)
        print(val)
        print(teams)
        '''
